...
| <a name="input_s3_global_policy_config"></a> [s3\_global\_policy\_config](#input\_s3\_global\_policy\_config) | Configure which policies will be enabled for resources created by this module | <pre>object({<br>    # Enable [x] policy<br>    enable_bucket_policy  = optional(bool, false)<br>    enable_kms_key_policy = optional(bool, false)<br>    # Use existing resources when available<br>    bucket_policy  = optional(any)<br>    kms_key_policy = optional(any)<br><br>  })</pre> | `{}` | no |
